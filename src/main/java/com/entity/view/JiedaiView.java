...
*/
@TableName("jiedai")
public class JiedaiView extends JiedaiEntity implements Serializable {
	...
	*/
	...
	public JiedaiView(JiedaiEntity jiedaiEntity) {
		try {
			BeanUtils.copyProperties(this, jiedaiEntity);
	...
	*/
	...
	public String toString() {
		return "JiedaiView{" +
			", jiedaiValue=" + jiedaiValue +
			", jiedaiZhuangtaiValue=" + jiedaiZhuangtaiValue +
