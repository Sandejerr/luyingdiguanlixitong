...
var centerMenu = [
    ...
    ,{
        name: '接待',
        url: '../jiedai/list.html'
    }
    ,{
        name: '结算',
        url: '../jiesuan/list.html'
    }
    ,{
        name: '营地预约',
        url: '../yingdiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '营地',
        url: './pages/yingdi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/luyingdiguanlixitong/admin/dist/index.html#/login";
